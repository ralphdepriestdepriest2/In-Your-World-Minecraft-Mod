...
public class PauseScreen extends Screen {
   ...
   private void createPauseMenu() {
      ...
      gridlayout$rowhelper.addChild(Button.builder(RETURN_TO_GAME, (p_96337_) -> {
      ...
      this.disconnectButton = gridlayout$rowhelper.addChild(Button.builder(component, (p_275864_) -> {
         p_275864_.active = false;
   ...
   public void render(PoseStack p_96310_, int p_96311_, int p_96312_, float p_96313_) {
      ...
      if (this.showPauseMenu && this.minecraft != null && this.minecraft.getReportingContext().hasDraftReport() && this.disconnectButton != null) {
         ...
         blit(p_96310_, this.disconnectButton.getX() + this.disconnectButton.getWidth() - 17, this.disconnectButton.getY() + 3, 182, 24, 15, 15);
      }
