...
public class AtaqueEntidadEntity extends PathfinderMob {
	public AtaqueEntidadEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InYourWorldModEntities.ATAQUE_ENTIDAD.get(), world);
	}
