...
import official.ebalia.inyourworld.procedures.ChickenEntityIsHurtProcedure;
...
public class ChickenEntity extends PathfinderMob implements GeoEntity {
	...
	public ChickenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InYourWorldModEntities.CHICKEN.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "chicken");
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new LookAtPlayerGoal(this, Player.class, (float) 1000));
