...
public class EntidadStalkerEntity extends Monster {
	public EntidadStalkerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InYourWorldModEntities.ENTIDAD_STALKER.get(), world);
	}
